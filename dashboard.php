...
// Example activities (could be fetched from DB)
$recentActivities = [
    ["icon" => "clock", "text" => "Maria Santos checked in late (9:15 AM)", "time" => "2 hours ago", "status" => "warning"],
    ["icon" => "dollar-sign", "text" => "November payroll processed successfully", "time" => "1 day ago", "status" => "success"],
    ["icon" => "user-plus", "text" => "New employee John Doe onboarded", "time" => "2 days ago", "status" => "info"],
    ["icon" => "clock", "text" => "5 employees submitted overtime requests", "time" => "3 days ago", "status" => "info"],
    ["icon" => "dollar-sign", "text" => "Sarah Wilson received performance bonus", "time" => "1 week ago", "status" => "success"]
];

// Quick actions (could also be links with PHP routing)
    ...
    <div id="userDropdown" class="hidden absolute right-0 mt-2 w-40 bg-white border rounded shadow-lg">
      ...
      <div class="px-6 mt-6">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 mt-6">
          <div class="shadow bg-white rounded-2xl p-6">
            <h2 class="text-sm font-medium text-gray-500 mb-4">Weekly Attendance</h2>
            <canvas id="attendanceChart"></canvas>
          </div>
          <div class="shadow bg-white rounded-2xl p-6">
            <h2 class="text-sm font-medium text-gray-500 mb-4">Payroll Distribution</h2>
