...
<a href="/web/hr3/index.php"
  ...
  <a href="/web/hr3/shift/hi.php"
     class="flex items-center gap-3 px-3 py-2 rounded hover:bg-gray-700 <?php echo ($currentPage == '/web/hr3/shift/hi.php') ? 'bg-gray-700 text-white' : ''; ?>">
